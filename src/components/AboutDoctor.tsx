...
export const AboutDoctor: React.FC = () => {
  ...
  const { doctorInfo, about } = siteData;
  ...
  const whatsappMessage = encodeURIComponent(
    `Olá ${doctorInfo.name}! Li sobre sua metodologia de atendimento domiciliar e gostaria de agendar uma consulta para meu pet.`
  );
          ...
          <div className="lg:col-span-5">
            <div className="relative mx-auto max-w-md">
              <div className="relative rounded-[36px] overflow-hidden shadow-xl border-4 border-[#FDFBF7] bg-orange-50">
                <img
                  src={about.imageUrl}
                  alt={`${doctorInfo.name} - ${doctorInfo.specialties}`}
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-6 rounded-3xl bg-[#FDFBF7] border-l-4 border-orange-500 shadow-sm relative">
              ...
              <div className="mt-3 flex items-center gap-2 text-xs font-bold text-orange-600">
                ...
                <span className="text-stone-500">{doctorInfo.crmv}</span>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <a
                ...
                href={`https://wa.me/${doctorInfo.whatsappNumber}?text=${whatsappMessage}`}
                target="_blank"
              ...
              >
                ...
                <span className="text-orange-600 font-bold whitespace-nowrap">{doctorInfo.instagram}</span>
              </a>
            </div>
          </div>
        </div>
